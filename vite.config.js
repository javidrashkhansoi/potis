  ...
  build: {
    rollupOptions: {
      input: {
        ...
        "draft-requirements": resolve(__dirname, "draft-requirements/index.html"),
        "draft-skills": resolve(__dirname, "draft-skills/index.html"),
        "draft-case": resolve(__dirname, "draft-case/index.html"),
        "draft-questions": resolve(__dirname, "draft-questions/index.html"),
      },
    },
  },
  css: {
